...
export interface ApiServiceTierServiceTier extends Struct.CollectionTypeSchema {
  collectionName: 'service_tiers';
  info: {
    displayName: 'ServiceTier';
    pluralName: 'service-tiers';
    singularName: 'service-tier';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    contactForInfo: Schema.Attribute.Boolean & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::service-tier.service-tier'
    > &
      Schema.Attribute.Private;
    medias: Schema.Attribute.Relation<'manyToMany', 'api::media.media'>;
    name: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::tag.tag'> &
      Schema.Attribute.Private;
    metadata: Schema.Attribute.Relation<'manyToMany', 'api::metadata.metadata'>;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::service-tier.service-tier': ApiServiceTierServiceTier;
